...
SOURCE_FILES := ./src/main.cpp ./src/polynomial.cpp ./src/polyrand.cpp ./src/generator.cpp ./src/utilsMethod.cpp ./src/grader.cpp ./src/SafeInput.cpp ./src/pSettings.cpp ./src/menu.cpp ./src/interactive.cpp
